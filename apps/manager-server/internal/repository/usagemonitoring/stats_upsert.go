...
func upsertAccountDailyBatch(ctx context.Context, tx *sql.Tx, revision string, afterID, throughID, nowMS int64) error {
	...
	insert into usage_monitoring_account_daily_rollups_v1 (
		...
		auth_file_snapshot, api_key_hash, executor_type, model, billing_model,
			...
			cache_creation_tokens, cache_creation_1h_tokens, long_input_tokens, long_output_tokens,
	...
	on conflict(
		...
		cache_creation_1h_tokens = usage_monitoring_account_daily_rollups_v1.cache_creation_1h_tokens + excluded.cache_creation_1h_tokens,
		...
		long_cache_creation_1h_tokens = usage_monitoring_account_daily_rollups_v1.long_cache_creation_1h_tokens + excluded.long_cache_creation_1h_tokens,
...
func upsertAPIKeyDailyBatch(ctx context.Context, tx *sql.Tx, revision string, afterID, throughID, nowMS int64) error {
	...
	insert into usage_monitoring_api_key_daily_rollups_v1 (
		...
		billing_model, pricing_model, service_tier, context_threshold_tokens,
			...
			cache_creation_1h_tokens, long_input_tokens,
			long_output_tokens, long_cached_tokens, long_cache_read_tokens,
			long_cache_creation_tokens, long_cache_creation_1h_tokens,
			total_tokens, zero_token_calls, latency_sum_ms,
	...
	on conflict(
		...
		cache_creation_1h_tokens = usage_monitoring_api_key_daily_rollups_v1.cache_creation_1h_tokens + excluded.cache_creation_1h_tokens,
		...
		long_cache_creation_1h_tokens = usage_monitoring_api_key_daily_rollups_v1.long_cache_creation_1h_tokens + excluded.long_cache_creation_1h_tokens,
